import 'package:balochi_tutor/models/notification_model/allow_notification_model/update_notification_response_model.dart';
...
class UpdateNotificationService {
  Future<ApiCallResponse<UpdateNotificationResponse>> callUpdateNotificationService(BuildContext context) async {
    try {
      var response = await Api().postRequest(context, AppUrl.updateAllowNotificationsApi, "", sendToken: true);
      debugPrint("Update Notification Response : $response");
      UpdateNotificationResponse responseModel = UpdateNotificationResponse.fromJson(response);
      debugPrint("Update Notification responseModel: ${responseModel.toJson()}");
