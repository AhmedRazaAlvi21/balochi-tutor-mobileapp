  ...
  Future<ApiCallResponse<UserProfileUpdateResponseModel>> callUserProfileUpdateService(BuildContext context) async {
    try {
      ...
      FormData formData = FormData.fromMap({
        "user_img": userImageFile ?? profileController.userProfileData.value?.userImg,
      ...
      var response =
          await Api().patchRequest(context, AppUrl.updateProfile, formData, sendToken: true, uploadDocument: true);
