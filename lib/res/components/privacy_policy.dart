...
class TermsAndPrivacyPolicyPage extends StatefulWidget {
  @override
  _TermsAndPrivacyPolicyPageState createState() => _TermsAndPrivacyPolicyPageState();
}

class _TermsAndPrivacyPolicyPageState extends State<TermsAndPrivacyPolicyPage> with SingleTickerProviderStateMixin {
      ...
      appBar: AppBar(
        ...
        title: Text(
          ...
          style: GoogleFonts.roboto(
            ...
            fontSize: 20 * context.textScaleFactorResponsive, // Use responsive font size
          ),
        ),
            ...
            children: [
              Text(
                ...
                style: GoogleFonts.roboto(
                  ...
                  // fontFamily: 'Poppins',
                  color: AppColor.blackColor,
                  fontSize: 22 * context.textScaleFactorResponsive, // Use responsive font size
                ),
              ),
              SizedBox(height: 8),
              Text(
